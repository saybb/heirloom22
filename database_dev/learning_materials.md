...
![image-20190908232504728](/Users/chuan/Library/Application Support/typora-user-images/image-20190908232504728.png)
...
- Descending
  - `ref.orderby(same_priority, "desc")`

### Limit 

- `ref.Orderby(field_name).limit(3)`
...
- Type checking
  - https://stackoverflow.com/questions/50996691/firestore-database-validation-on-type
